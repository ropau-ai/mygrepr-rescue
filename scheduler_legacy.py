"""
Grepr Scheduler - LEGACY (frozen for `compare` mode reference).

This is the original sequential pipeline:
- fetch each subreddit sequentially
- fetch top comment sequentially with sleep(0.5)
- AI categorization with fixed sleep(AI_DELAY=8.0s) between calls

Kept here as the "before" side of `python scheduler.py compare`.
Do not import this in production paths — use scheduler.py.
"""
import json
import os
import time
